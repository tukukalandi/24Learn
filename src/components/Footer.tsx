        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center gap-2">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-ncert-maroon text-white shadow-lg shadow-ncert-maroon/20">
                <Globe size={24} />
              </div>
              <span className="font-display text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
                Dak<span className="text-ncert-maroon">Shiksha</span>
              </span>
            </Link>
            ...
            <div className="mt-6 flex gap-4">
              <a href="#" className="text-slate-400 hover:text-ncert-maroon transition-colors"><Twitter size={20} /></a>
              <a href="#" className="text-slate-400 hover:text-ncert-maroon transition-colors"><Instagram size={20} /></a>
              <a href="#" className="text-slate-400 hover:text-ncert-maroon transition-colors"><Github size={20} /></a>
              <a href="#" className="text-slate-400 hover:text-ncert-maroon transition-colors"><Mail size={20} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-slate-600 dark:text-slate-400">
              <li><Link to="/" className="hover:text-ncert-maroon transition-colors">Home</Link></li>
              <li><Link to="/about" className="hover:text-ncert-maroon transition-colors">About Us</Link></li>
              <li><Link to="/competitive-exams" className="hover:text-ncert-maroon transition-colors">Exams</Link></li>
              <li><Link to="/contact" className="hover:text-ncert-maroon transition-colors">Contact</Link></li>
            </ul>
          </div>
